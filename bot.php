...
if($text){
    ...
    // -- ПОМОЩЬ
        ...
        $reply .= '<b>Начать</b> - Отменить регистрацию на событие. Выбрать другое событие. Вводить вручную как обычное сообщение.' . PHP_EOL;
        $reply .= '<b>Сброс</b> - Удалить всю свою статистику и начать заново. Вводить вручную как обычное сообщение.' . PHP_EOL;
        ...
        if (isAdmin($nickName)) {
            ...
            $reply .= '<b>Участники</b> - Показывает людей заявившихся на событие. Также показывает список скинувших боту статистику. В скобках - сколько раз (1-один или 2-много).' . PHP_EOL;
        ...
        $reply .= PHP_EOL;
        $reply .= 'Для некоторых команд выводятся кнопки, некоторые нужно вводить вручную, чтобы не использовать случайно.' . PHP_EOL;
        $reply .= PHP_EOL;
